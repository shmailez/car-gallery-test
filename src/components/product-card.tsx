...
export default function ProductCard({car, currentImageIndex, handleImageChange,} : {
    ...
    return (
      <div key={car.unique_id} className="rounded-[10px] p-4 shadow bg-white relative pb-24">
        <CardGallery
            key={car.unique_id}
            car={car}
        ...
        />
        <h2 className="text-lg text-gray-600 font-semibold mt-2">{car.mark_id} {car.folder_id}</h2>
        <p className="text-purple-900 font-bold text-lg mt-2">{car.price.toLocaleString()} ₽</p>
        <div className="flex flex-wrap">
          <p className="flex items-center mr-4 text-gray-600">
        ...
        <div className="mt-6 mb-2 flex absolute bottom-0 justify-between w-full">
          <div>
            <button className="text-gray-900 bg-gray-200 border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-400 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
              <svg className="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12.01 6.001C6.5 1 1 8 5.782 13.001L12.011 20l6.23-7C23 8 17.5 1 12.01 6.002Z"/>
              </svg>
            </button>
            <button className="text-gray-900 bg-gray-200 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-400 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
        ...
        <button className="text-white bg-violet-900 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-8 me-2 mb-2 dark:bg-violet-900 dark:hover:bg-violet-900 focus:outline-none dark:focus:ring-blue-800">
