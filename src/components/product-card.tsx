...
export default function ProductCard({car, currentImageIndex, handleImageChange,} : {
    ...
    return (
      <div key={car.unique_id} className="rounded-[10px] p-4 shadow bg-white relative pb-24">
        ...
        <p className="text-blue-600 font-bold text-lg mt-2">{car.price.toLocaleString()} ₽</p>
        ...
        <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-8 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
          <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
