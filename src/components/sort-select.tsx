export default function SortSelect({sort, handleSortChange} : {
    ...
    <div className="mb-4 bg-white p-4 rounded-[10px]">
        <label className="mr-2 font-medium text-purple-700">Сортировка по цене:</label>
        <select value={sort} onChange={handleSortChange} className="text-purple-700 p-2 rounded">
